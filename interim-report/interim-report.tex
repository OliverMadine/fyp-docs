...
% q1: how does the error example relate to the parser? it could just be inherent to the compiler
%q: why is testing parsers vital/is it the only way to improve parser reliability?
...
% Some of the unique challenges of this work include handling non-terminating parsers, and constructing valid inputs for generated parsers.
...
\subsection{Unique Benefits} % \subsection{Results}
